...
$query = " SELECT v.id, v.topic, v.video_link, v.description, v.upload_time, v.active, c.category
          ...
          WHERE v.active = 1 AND v.categories = 3
...
<body>
    ...
    <section id="services">
        <div class="p-5 mb-4 bg-light bg-gradient text-dark">
            <div class="container   py-5 text-center">
                <h1 class="display-4 fw-bold">Life Services</h1>
                <p class="col-md-8 mx-auto fs-5">
                    "Life is not just a journey, but a series of experiences, challenges, and joys that we navigate together, hand in hand, through every moment." </p>
    ...
    <section class="about py-5 bg-grey" style="padding-bottom: 100px;">
        <div class="container">
            <div class="text-center mb-5">
                <h2 class="text-center text-dark display-4 fw-bold ">One Life to Live and One Life to Love</h2>
                <p>
                    "If living life is a skill then this skill can be taught."
                </p>
            </div>
            <div class="row">
                <div class="col-md-6" data-aos="fade-right">
                    <img src="./li.webp" class="img-fluid shake" alt="About Us" style="height: 100%;" />
                </div>
                <div class="col-md-6 d-flex align-items-center">
                    ...
                    <div>
                        <h2 class="display-5 fw-bold">A Course On</h2>
                        <ul class="list-group">
                            <li class="list-group-item">Happiness Course</li>
                            <li class="list-group-item">Marriage and Relationship Counseling</li>
                            <li class="list-group-item">Life Challenges</li>
                        </ul>
